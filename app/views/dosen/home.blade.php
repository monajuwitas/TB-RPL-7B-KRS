...
<div class="row">
        <div class="row" id="logo_menu">
           ...
           <div class="col-md-2 jarak_bawah" style="text-align:center">
              <a class="logo logo_event" href="{{URL::to('profildosen')}}" target="_blank"><img src="{{asset('/assets//css/img/profil.png')}}" alt="" style="height:150px" "width:200px"></a>
              <h4 class="wow animated fadeInDown h2color" data-wow-delay="0.5s">Profil</h4>
           </div>
           <div class="col-md-2 jarak_bawah" style="text-align:center">
             <a class="logo logo_event" href="{{URL::to('mhs')}}" target="_blank" ><img src="{{asset('/assets//css/img/mahasiswa.png')}}" alt="" style="height:150px" "width:200px"></a>
             <h4 class="wow animated fadeInDown h2color" data-wow-delay="0.5s">Mahasiswa</h4>
           
           </div>
           <div class="col-md-2 jarak_bawah" style="text-align:center">
             <a class="logo logo_event" href="{{URL::to('krshome')}}" target="_blank"><img src="{{asset('/assets//css/img/krs.png')}}" alt="" style="height:150px" "width:200px"></a>
             <h4 class="wow animated fadeInDown h2color" data-wow-delay="0.5s">KRS</h4>
           </div>
           <div class="col-md-2 jarak_bawah" style="text-align:center">
             <a class="logo logo_event" href="{{URL::to('bomhs')}}" target="_blank"><img src="{{asset('/assets//css/img/bimbingan.png')}}" alt="" style="height:150px" "width:200px"></a>
